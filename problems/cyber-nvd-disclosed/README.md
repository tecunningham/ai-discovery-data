...
![Annual CVE disclosures in the US National Vulnerability Database.](discovery-cyber-nvd-disclosed.png)
...
draws one bar per year from the `nvd_published` column of `nvd-by-year.csv`.
