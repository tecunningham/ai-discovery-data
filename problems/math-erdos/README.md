...
disproved or solved on the day it ran (556 rows, against 579 in the same
...
about 13 against stocks of 579 and 1,221 it would not resolve on the linear
...
- **the two stocks are not an AI-versus-human flow.** The roughly 13
  AI-standalone resolutions and the 579 solved statuses are counted on
