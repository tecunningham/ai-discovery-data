...
**Data:** [`../data/sphere-packing-lower-bound-records.csv`](../data/sphere-packing-lower-bound-records.csv)
...
![Cumulative improvements in the asymptotic sphere-packing lower-bound ladder, 1905 to 2025.](../figures/discovery-math-sphere-packing.png)
...
[analytic-number-theory exponents](math-antedb.md) over the same window, this is
...
`sphere_chart()` in [`../tools/make_figures.py`](../tools/make_figures.py) reads
...
[finite-construction groups](math-alphaevolve-related-records.md) are counted
rather than plotted.
...
[analytic-number-theory exponents](math-antedb.md), which are structurally the
...
[finite constructions](math-alphaevolve-related-records.md)).
