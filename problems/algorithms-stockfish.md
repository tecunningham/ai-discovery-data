...
**Data:** [`../data/stockfish-ncm-elo.csv`](../data/stockfish-ncm-elo.csv)
**Upstream:** <https://nextchessmove.com/dev-builds>
**Verdict:** no acceleration

![Stockfish development-build Elo against Stockfish 15 from 2013 to 2026, with releases marked and the first LLM-credited commit open.](../figures/discovery-algorithms-stockfish.png)
...
`stockfish_chart()` in [`../tools/make_figures.py`](../tools/make_figures.py)
...
[modded-nanogpt](algorithms-nanogpt.md), where four of 86 records are AI-credited
at roughly one percent each. The one deeper AI step anywhere nearby is on the
[CIFAR-10 speedrun](algorithms-cifar10.md), at about 23%.
