...
**Data:** [`../data/nanogpt-records.csv`](../data/nanogpt-records.csv)
...
![All 86 modded-nanogpt records on a log time axis, with the four AI-credited records in red.](../figures/discovery-algorithms-nanogpt.png)
...
`nanogpt_chart()` in [`../tools/make_figures.py`](../tools/make_figures.py)
...
first acknowledged AI record on the [CIFAR-10 speedrun](algorithms-cifar10.md),
