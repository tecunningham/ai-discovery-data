...
31 problems holding 37 figures and 39 data files. 19 refetch from upstream and 12 are maintained by hand and say so. 14 recompute their prose arithmetic; the other 17 state numbers no check reads. No failing cells.
...
stays the thing that decides it. Twelve folders do this today; the rest print
numbers no check reads, and their ➖ says so rather than claiming a pass.
