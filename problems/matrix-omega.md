...
**Data:** [`../data/matrix-multiplication-omega.csv`](../data/matrix-multiplication-omega.csv)
...
![Best proved upper bound on the matrix-multiplication exponent from 1969 to 2024, every step human.](../figures/discovery-matrix-omega.png)
...
`matrix_omega_chart()` in [`../tools/make_figures.py`](../tools/make_figures.py)
