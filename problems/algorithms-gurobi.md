...
**Data:** [`../data/gurobi-milp-speedups.csv`](../data/gurobi-milp-speedups.csv)
...
![Cumulative Gurobi MILP speedup across releases 10 to 13, drawn in vendor grey.](../figures/discovery-algorithms-gurobi.png)
...
`gurobi_chart()` in [`../tools/make_figures.py`](../tools/make_figures.py) reads
