...
Writes data/alphaevolve-records.csv and prints the
comparison the AlphaEvolve discussion lacks: how large the AI-era step was
against the distribution of historical steps on the same quantity.
...
OUT = ROOT / "data/alphaevolve-records.csv"
...
def main() -> int:
    ...
    print(f"\nwrote {len(data)} rows to {OUT.relative_to(ROOT)}")
    return 0
