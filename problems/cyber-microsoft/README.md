...
AI-marked CVEs, or 1.5% of the part year, of which 19 name an AI system or
method and 3 name only an AI-security employer. Whatever is driving the 2026
...
- **Vendor policy moves the count.** In mid-2024 Microsoft began issuing CVEs
  ...
  23 CVEs in 2024, 68 in 2025 and 108 in the 2026 part year. That is real but
...
ENKI WhiteHat [@secagent2026slyp]. In the 2026 part year, of the 22 AI-marked
CVEs, 12 credit the SEC-agent team, 7 credit Claude or Anthropic — Calif.io
and Milad Nasr of Anthropic "with Claude", and Adrian Denkiewicz at Doyensec
with Anthropic Research [@anthropicmythos2026] — and 3 credit XBOW, an
affiliation with no method stated. One of the Claude-credited CVEs is
co-credited to Microsoft's own WARP and MORSE teams. Set against the 1,507
