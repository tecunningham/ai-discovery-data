...
The instrument warning that applies to [Hilbert](../math-hilbert/README.md) applies here
...
year from the 1998 `list_year` to the present. The resolved/open/contested
split is stated in the chart's corner note and in the prose above.
...
There is no `fetch.py`. The rows are hand-scored from the Wikipedia table and, for the 2026 counterexample, from the two independent formal verifications named in the header — which is the kind of judgment no fetcher could make.
...
- **Rows overlap other lists.** Smale 1 is the Riemann hypothesis, Smale 3 is P
  ...
  [Hilbert](../math-hilbert/README.md) and [Millennium](../math-millennium/README.md) rather than
  independent of them.
...
read by experts. Read against the [Millennium](../math-millennium/README.md) list, which
has not moved since 2003, and against [Hilbert](../math-hilbert/README.md), which has not
