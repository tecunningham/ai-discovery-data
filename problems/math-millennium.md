...
![Cumulative resolved Millennium Prize Problems, flat at one since Perelman's 2003 Poincaré result.](../figures/discovery-math-millennium.png)
...
`problem_list_chart("millennium", ...)`, called from `math_charts()` in
...
- **The resolution date is a choice.** Preprints 2002–2003, prize 2010; the chart
  uses 2003.
- **The rows overlap other lists.** Riemann appears on [Hilbert](math-hilbert.md)
  and [Smale](math-smale.md) too, and P versus NP on Smale, so this is not an
...
answer is [Smale](math-smale.md), where one row fell in 2026 to an AI-assisted
finite counterexample that could be machine-checked, and [Erdős](math-erdos.md),
...
[@sherry2021fast]. The companion ledgers are [Hilbert](math-hilbert.md),
[Smale](math-smale.md) and [TOPP](math-topp.md).
