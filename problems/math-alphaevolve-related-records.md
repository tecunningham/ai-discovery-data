...
**Data:** [`../data/alphaevolve-records.csv`](../data/alphaevolve-records.csv), with the sampling frame in [`../data/alphaevolve-inventory.csv`](../data/alphaevolve-inventory.csv)
...
![Cumulative record steps in five finite construction and packing problem groups, with AI steps in red.](../figures/discovery-math-alphaevolve-related-records.png)
...
`related_alphaevolve_chart()` in
[`../tools/make_figures.py`](../tools/make_figures.py) holds the five problem ids
...
[sphere-packing ladder](math-sphere-packing.md) makes for the same reason.
...
frame are [kissing number](math-kissing-11.md) and
