...
- **Verdict:** inconclusive — 2 record steps in 2026 against 0 in 2025 and 1
in 2024; 4 steps over 2001–2026 against 14 over 1974–2000

![Record rank of an elliptic curve over Q from 1938 to 2026; the 2026 rank 30 step is AI-credited.](discovery-math-elliptic-rank.png)
...
- **steps:** 20 recorded steps, 1938 to 2026, 19 credited human and 1 credited
  ai
- **span:** rank ≥ 3 (Billing, 1938) to rank ≥ 31 (Alp&ouml;ge–Howell, 2026)
- **by-period:** 2 steps over 1938–1945 · 14 steps over 1974–2000 · 4 steps
  over 2001–2026
- **longest gap:** 29 years, from 1945 to 1974
- **recent steps:** rank ≥ 28 (Elkies, 2006) · rank ≥ 29 (Elkies–Klagsbrun,
  2024) · rank ≥ 30 (Alp&ouml;ge–Howell, 2026) · rank ≥ 31 (Alp&ouml;ge–Howell,
  2026)
- **exact frontier:** 8 recorded steps, rank = 10 (Kretschmer, 1986) to rank =
  20 (Elkies–Klagsbrun, 2020)
- **ai-attributed:** 1 of 20 record steps, the 2026 rank ≥ 30 step
...
The 2026 rank ≥ 30 record answers a dated public challenge. On 2026-08-05,
fifteen days before the curve was submitted, Bartosz Naskręcki posed rank 30
as a problem addressed to AI systems as well as to people:
...
The rank ≥ 30 record then stood for three days on the board: curve #302, with
31 independent points, was submitted on 2026-08-23 under Ava Howell's name,
and Dujella's table records the rank ≥ 31 record as Alp&ouml;ge–Howell, 2026,
under an ordinary human credit. The standing record is rank ≥ 31.
...
2026 rank ≥ 30 row is set to `ai` / `self-reported`, and the evidence for it
is quoted in the AI-attribution register below.
...
- **a secondary chronology.** The record rows reproduce one maintainer's
  table and its subpages rather than twenty primary papers read in turn.
  Dujella's own reference list is carried on the same page and is not
  transcribed here.
- **the table is the scoring rule.** The page's prose still named rank ≥ 29
  as the current record while its table and subpage carried the 2026 rank ≥ 30
  row, as of the 2026-08-20 read; the CSV follows the table.
...
- **the 2026 rank ≥ 30 credit is self-reported.** It rests on one editable commentary
...
- **discoverer:** Alp&ouml;ge–Howell in Dujella's table; the curve was
  submitted by `ranksunbounded`, a pseudonymous leaderboard account
