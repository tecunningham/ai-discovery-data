...
36 problems holding 84 figures and 59 data files. 22 refetch from upstream and 14 are maintained by hand and say so. 36 recompute their prose arithmetic; the other 0 state numbers no check reads. No failing cells.
