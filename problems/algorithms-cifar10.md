...
**Data:** [`../data/cifar-speedrun-records.csv`](../data/cifar-speedrun-records.csv)
...
![CIFAR-10 speedrun records on a log time axis, with AI records red and the unacknowledged claim open.](../figures/discovery-algorithms-cifar10.png)
...
[modded-nanogpt](algorithms-nanogpt.md). A further claim of 1.828 seconds,
...
`cifar_chart()` in [`../tools/make_figures.py`](../tools/make_figures.py) reads
...
record 32 on [modded-nanogpt](algorithms-nanogpt.md).
...
[modded-nanogpt](algorithms-nanogpt.md) is the closest comparator, and shows AI
